...
const tables = [
  {
    ...
    columns: [
      ...
      { name: "isPro", type: "bool", defaultValue: "false" },
      { name: "mapsToUse", type: "text", defaultValue: "apple" },
    ],
    revLinks: [
...
const defaultOptions = {
  databaseURL:
    "https://angedell-s-workspace-24qeiq.us-east-1.xata.sh/db/newyork-citybike",
};
